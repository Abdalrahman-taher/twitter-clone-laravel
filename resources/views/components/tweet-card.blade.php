        ...
        <div class="flex gap-3">
            ...
            <div class="min-w-0 flex-1">
                <div class="flex items-start justify-between gap-3">
                    {{-- User Profile Link --}}
                    <a href="{{ route('profile.show', $tweet->user) }}"
                       class="min-w-0 text-sm leading-tight">
                ...
                <p class="mt-2 whitespace-pre-line break-words text-[15px] leading-5 text-white">
                    {{ $tweet->body }}
                </p>

                {{-- Tweet Media --}}
                <x-media-gallery :model="$tweet" :compact="$nested" />
                ...
                <div class="mt-3 flex items-center justify-between border-y {{ $actionsBorderClass }} py-2 text-sm text-gray-500">
                    ...
                    <button
                        ...
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-full transition duration-200 hover:bg-blue-500/10">
                            <svg
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                class="h-5 w-5">

                                <path d="M14.046 2.242l-4.148-.01h-.002c-4.374 0-7.8 3.427-7.8 7.802 0 4.098 3.186 7.206 7.465 7.37v3.828c0 .108.044.286.12.403.142.225.384.347.632.347.138 0 .277-.038.402-.118.264-.168 6.473-4.14 8.088-5.506 1.902-1.61 3.043-3.97 3.043-6.312v-.017c-.006-4.367-3.43-7.787-7.8-7.788z"/>
                    ...
                    <form
                        ...
                        <button
                            ...
                            <span class="inline-flex h-8 w-8 items-center justify-center rounded-full transition duration-200 hover:bg-green-500/10">
                                <svg
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    class="h-5 w-5">
                    ...
                    <form
                        ...
                        <button
                            ...
                            <span class="inline-flex h-8 w-8 items-center justify-center rounded-full transition duration-200 hover:bg-red-500/10">
                                <svg
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    class="h-5 w-5">
                                ...
                                <a href="{{ route('profile.show', $comment->user) }}"
                                   class="h-8 w-8 shrink-0 overflow-hidden rounded-full">
                                    ...
                                    @else
                                        ...
                                        <div class="flex h-full w-full items-center justify-center bg-gray-700 text-gray-500">
