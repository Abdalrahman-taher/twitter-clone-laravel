...
<div style="width: 275px;">
    <div class="overflow-y-auto fixed h-screen pr-3" style="width: 275px;">
        ...
        <nav class="mt-5 px-2">
            <a href="{{ route('home') }}"
               class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300 {{ request()->routeIs('home') ? 'bg-gray-800 text-blue-300' : '' }}">
            ...
            <a href="{{ route('search.index') }}"
               class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300 {{ request()->routeIs('search.index') ? 'bg-gray-800 text-blue-300' : '' }}">
            ...
            <a href="{{ route('notifications.index') }}"
               class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300 {{ request()->routeIs('notifications.*') ? 'bg-gray-800 text-blue-300' : '' }}">
                <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                     stroke="currentColor" viewBox="0 0 24 24">
                    <path
            ...
            <a href="{{ route('messages.index') }}"
               class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300 {{ request()->routeIs('messages.*') ? 'bg-gray-800 text-blue-300' : '' }}">
            ...
            <a href="{{ route('bookmarks.index') }}"
               class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300 {{ request()->routeIs('bookmarks.*') ? 'bg-gray-800 text-blue-300' : '' }}">
