{{-- ========================================= --}}
{{-- Feed Column (Create Tweet + Tweets List)  --}}
{{-- Wrapped in flex-col so everything stacks   --}}
{{-- vertically as ONE column, no matter how    --}}
{{-- the parent layout positions this file.     --}}
{{-- ========================================= --}}
...
<div class="flex flex-col w-full">
    ...
    {{-- ========================================= --}}
    {{-- Create Tweet Form --}}
    {{-- Sends a new tweet to the backend --}}
    {{-- ========================================= --}}
    ...
    {{-- ========================================= --}}
    {{-- Tweets Feed --}}
    {{-- One tweet per <li>, stacked in this same  --}}
    {{-- vertical column, directly under the form  --}}
    {{-- ========================================= --}}
