                        ...
                        <div class="flex items-center py-4">
                            ...
                            <div class="flex-1">
                                ...
                                <form
                                    ...
                                    method="POST"
                                    class="flex items-center text-white text-xs hover:text-red-600 transition duration-350 ease-in-out">

                                    @csrf

                                    {{-- the user make a like to the tweet ? --}}
                            ...
                            <div
                                ...
                                <svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-2">
                                    <g>
                                        <path
                                            d="M17.53 7.47l-5-5c-.293-.293-.768-.293-1.06 0l-5 5c-.294.293-.294.768 0 1.06z"></path>
                                    </g>
                                </svg>
